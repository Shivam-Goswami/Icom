...
<body class="main-container">
    ...
    <div class=" text-center">
        <h1>Lets find out if you are depressed</h1>
    </div>
    <!-- start Quiz button -->
    ...
    <div class="result_box">
        ...
        <div class="complete_text">You have completed it!</div>
  ...
  ';
        ...
        echo'
        <div class="container">
        <h1 class= "py-2">To Find Out Your Sentiments, Please Login!</h1>
        <p class= "lead">You are not logged in. Please login to be find out sentiment.</p>
    </div>
        ';
    }
    ?>
    ...
    <script src="dquestions.js"></script>
